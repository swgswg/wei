...
module.exports = {
    ...
    // 添加评论
    insertComment: function (mygoodsid, myuser_id, mydetail, myimg, mygrade, myorder_mainid, mystatus, pageobj, callback) {
        let data = {
            goodsId: mygoodsid,
            user_id: myuser_id,
            detail: mydetail,
    ...
    // 根据user_id查询用户拥有优惠券
    getUserCoupon: function (myuser_id, pageobj, callback) {
        this.requestUrl({ user_id: myuser_id }, urlData.getUserCouponUrl, pageobj, callback);
    },
    ...
    // 根据店铺查询优惠券
    getCoupon: function (myshop_code, pageobj, callback) {
        this.requestUrl({ shop_code: myshop_code }, urlData.getCouponUrl, pageobj, callback);
    },

    // 删除优惠券
    deleteCoupon: function (mycouponId, pageobj, callback) {
        this.requestUrl({ couponId: mycouponId }, urlData.deleteCouponUrl, pageobj, callback);
    },
