...
Page({
    ...
    onLoad: function (options) {
        ...
        // 查询商品列表
        setTimeout(function () {
            funData.getShopCode(app.globalData.user_id, that, (res) => {
                // console.log(data);
                funData.getGoods(res.shop_code, page, pageSize, that, (data) => {
                    // console.log(data);
   ...
   */
    ...
    addGoods: function () {
        ...
        wx.navigateTo({
            url: '/pages/myGoods/addGoods/addGoods'
        });
    },
